...
- **Windows:** Kerberos, WinAPI, NtAPI, Windows-Performance-Analyzer (WPA), Event-Tracing for Windows (ETW) Windows-Management-Interface (WMI), Component-Object-Model (COM), Kernel-Mode Driver-Framework (KMDF), IRQL Handling, KPP (Kernel-Patch Protection)
